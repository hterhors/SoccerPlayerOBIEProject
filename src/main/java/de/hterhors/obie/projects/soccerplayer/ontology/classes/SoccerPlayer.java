...
if(soccerPlayer.getPositionAmerican_football_positions()!=null)this.positionAmerican_football_positions = (IAmerican_football_positions) IOBIEThing.getCloneConstructor(soccerPlayer.getPositionAmerican_football_positions().getClass())	.newInstance(soccerPlayer.getPositionAmerican_football_positions());
