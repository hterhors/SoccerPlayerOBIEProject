...
static class SoccerClubIndividual extends AbstractOBIEIndividual {
	...
	private static final long serialVersionUID = 1L;		public SoccerClubIndividual(String namespace, String name) {
...
final private String textMention;
	...
	public SoccerClub(String individualURI, String annotationID, String textMention){
this.individual = 
...
this.annotationID = soccerClub.getAnnotationID();
...
@Override
public String toString(){
return "SoccerClub [individual="+individual+",annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
